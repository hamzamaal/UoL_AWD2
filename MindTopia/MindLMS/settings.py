...
These settings are configured for local development and coursework
submission. Production deployments should replace placeholder values,
restrict hosts, and move secrets into environment variables.
"""
